...
{
    public partial class LecturerForcePasswordReset : Page
    {
        ...
        private void InitPage()
        {
            ...
            {
                // Only lecturers (Educator) can use this page
            ...
            using (var cmd = new SqlCommand(@"
                ...
                FROM dbo.Users
                WHERE UserId = @id AND UserType = 'Educator';", con))
            {
                ...
                using (var rd = cmd.ExecuteReader())
                {
                    ...
                    // If reset is no longer required, send them straight to dashboard
                    if (!isResetRequired)
                    {
        ...
        protected void btnChangePassword_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Success → go to lecturer dashboard
                Response.Redirect("~/Lecturer/LecturerDashboard.aspx", true);
            }
            catch (Exception ex)
            {
